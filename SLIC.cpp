...
///
/// There is option to save the labels if needed.如果需要，可以选择保存标签。
//===========================================================================
...
///
/// Zero parameter SLIC algorithm for a given number K of superpixels.零参数SLIC算法对于给定的K个超像素
//===========================================================================
